...
const DID='did:hive:hiveforce-logistics';const ID={name:'HiveForce-Logistics',purpose:'Supply chain and logistics routing — optimal paths, carrier selection, tracking',capabilities:["route_optimization","carrier_selection","shipment_tracking","demand_forecasting"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-logistics-router',purpose:ID.purpose})}
